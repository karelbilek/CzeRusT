...
not taking into account morphological or syntactic errors.%\footnote{though they really matter, plans for future}
...
\textit{adj::lemma+::stem+-::полноценный military resource} means that %TODO add package cyrillic
...
\begin{tabular}{|r|c|c|c|c|c|c|}
  \hline
 \textbf{pos} & \multicolumn{3}{|c|}{\textbf{lemma}} & \multicolumn{3}{c}{\textbf{stem}} \\ \hline
           & +      & -      & oov & +      & -      & oov  \\ \hline
  adj      & 15     & 0      & 17  & 31     & 4      & 0 \\
  noun     & 29     & 3      & 18  & 39     & 7      & 4 \\
  verb     & 8      & 1      & 3   & 6      &8       & 2 \\
  NE       &10      & 0      & 30  & 13     & 5      & 22 \\
gerund     &13      & 6      & 12  & 20     &10      & 0 \\
\hline
\end{tabular}
\end{center}
\caption{Manual oov analysis for Russian-to-English}
...
We have also spotted some problems with concrete groups of words. %not exactly part of speech
...
%the table for ru-cs and bla-bla later...
...
\bibitem[Popovic 2004]{popovic} Popovic,M., Hermann, N.: Towards the Use of Word Stems and Suffixes for Statistical Machine Translation. 
...
\bibitem[Gispert]{gispert} Gispert,A., Marino,J, Crego, J: Improving statistical machine translation by classifying and generalizing inflected verb forms.  
In: Proceedings of 9th European Conference on Speech Communication and Technology

\bibitem[Turchi]{turchi} Turchi, M., Ehrmann, M.: Knowledge Expansion of a Statistical Machine Translation System using Morphological Resources. 
In: Polibits, (43), 37-43, 2011.

\bibitem[Bojar, Tamchyna]{bojartamchyna} Bojar,O., Tamchyna, A.: Forms Wanted: Training SMT on Monolingual Data.
In: Proceedings Research Workshop of the Israel Science Foundation University of Haifa, Israel. 2011.

\bibitem[Hoang, Birch]{moses}Koehn, P., H. Hoang, A. Birch et al: Moses: Open source toolkit for statistical machine translation.
